import pprint;
message = 'It was a bright cold day in April, and te clocks were striking thirteen.'

romioJuliet = '''The Project Gutenberg EBook of Romeo and Juliet, by William Shakespeare
...
for character in romioJuliet:
    count.setdefault(character, 0)
    count[character] = count[character]+1

print("Message length : ", str(len(romioJuliet)))
print("Each character wise repetition :")
print(count)
